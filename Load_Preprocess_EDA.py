...
def correlation_heatmap(dfSamples):
    ...
    data = dfSamples[["tSample_normalized", "RX", "RY", "RPupil_normalized", "LX", "LY", "LPupil_normalized", "is_MW"]]
...
#%%
# Drop "Unnamed: 0", "LPupil", "RPupil"
dfSamples = dfSamples.drop(["LPupil", "RPupil"], axis=1)
print(dfSamples.columns)

# save csv
dfSamples.to_csv("E:\\MW_Classifier_Data\\all_subjects_data_no_interpolation.csv")

#%%
dfSamples = pd.read_csv("E:\\MW_Classifier_Data\\all_subjects_data_no_interpolation.csv")
print(dfSamples["Subject"])
print(dfSamples["Subject"].unique())
print(len(dfSamples))
# if str change plot fntns
#%% Plot
subjects = [10014,10052,10059,10073,10080,10081,10084,10085,10089,10092,10094,
            10100,10103,10110,10111,10115,10117,10121,10125]
